...
const HighValueLeadsForm = () => {
  ...
  useEffect(() => {
    ...
    setValue("projectKeyword", row?.projectKeyword);
    setValue("retail", row?.retail);
    setValue("altNumber", row?.altNumber);
    setValue("pin", row?.pin);
    setValue("retailName", row?.retailName);
    setValue("retailNumber", row?.retailNumber);
    setValue("retailEmail", row?.retailEmail);
    setValue("retailAddress", row?.retailAddress);
    setValue("retailCity", row?.retailCity);
    setValue("retailState", row?.retailState);
    setValue("retailPincode", row?.retailPincode);
    setValue("retailSource", row?.retailSource);
    setValue("retailProject", row?.retailProject);
    setValue("dob", row?.dob);
    setValue("requirement", row?.requirement);
    setValue("kilowatts", row?.kilowatts);
    setValue("clientlevel", row?.clientlevel);
    setValue("followUpDate", row?.followUpDate);
    setValue("remarks", row?.remarks);
    setValue("referralName", row?.referralName);
...
export default HighValueLeadsForm;
